...
var commands = []*Command{
	...
	NewCommand(0, "ntp", `
		...
		`),
	NewCommand(0, "user_account_control", `
		Get-ItemProperty "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System"
		`),
	NewCommand(0, "remote_desktop", `
	...
	NewCommand(0, "dns", `
		...
		`),
	NewCommand(0, "nic_teaming_config", `
		Get-NetLbfoTeamNic
		`),
	NewCommand(0, "tcp", `
